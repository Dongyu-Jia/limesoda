...
**Instructions:**
1. **Terraform Mapping:** Strictly map resources to the P4 Architecture RFC (e.g., if P4 requested a 50GB PostgreSQL instance, you MUST provision exactly that).
